    ...
    return(
        <div>
            ...
            <motion.div initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}}>
                <Container className="myProjectContainer">
                    <Row id="Individual">
            ...
            <motion.footer className='myProjectsFooter' initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}}><PageFooter></PageFooter></motion.footer>
        </div>
    )
}