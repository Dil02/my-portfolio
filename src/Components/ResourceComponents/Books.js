    ...
    return (
        <div className="Books">
            ...
            <motion.div initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}}>
                <Container fluid>
                    <h6 className="display-6">Recommended Reads:</h6>
                    <Row className="gy-3">
                        <Col>    
                            <CardGroup>
                                ...
                                <Card className="bookCards">
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Text>
                                            A brilliant tale of how a manager transforms his failing manufacturing plant within 3 months. Facing various personal challenges along the way.
                                        </Card.Text>
                                    </Card.Body>
                                </Card>
                            </CardGroup>
            ...
            <motion.footer initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} className='myBookFooter'><PageFooter></PageFooter></motion.footer>
        </div>
    )
}