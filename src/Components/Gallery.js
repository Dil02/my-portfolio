        ...
        <motion.div initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} className='Gallery mb-2'>
            <Container fluid>
                <Row>
                    <Col>
                        <Row>
                            <Col><motion.img src={"/Photos/GeoTrip/Mattiscombe Sands.jpg"} alt="Geo Trip" className='Landscape' onClick={() => {navigate("/Album/:Geography Field Trip")}} whileHover={{scale: 1.02}}></motion.img></Col>
                        </Row>
                        <Row className='mt-4'>
                    ...
                    <Col><motion.img src="/Photos/VED/Ford GT.jpg" alt="VED" className='Portrait' onClick={() => {navigate("/Album/:Vehicles")}} whileHover={{scale: 1.02}}></motion.img></Col>
                </Row>
            </Container>
        </motion.div>
    )
